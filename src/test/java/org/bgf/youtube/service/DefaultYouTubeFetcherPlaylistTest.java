...
class DefaultYouTubeFetcherPlaylistTest {
    ...
    void excludesPrivateAndUploads() {
        ...
        client.playlists = List.of(
                new YouTubeClient.PlaylistDTO("PL1", "Uploads", "d", Instant.EPOCH, "public", true),
                new YouTubeClient.PlaylistDTO("PL2", "Private PL", "d", Instant.EPOCH, "private", false),
                new YouTubeClient.PlaylistDTO("PL3", "Public PL", "d", Instant.EPOCH, "public", false)
        );
